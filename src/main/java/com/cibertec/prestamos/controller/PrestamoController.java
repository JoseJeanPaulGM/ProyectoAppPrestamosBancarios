...
public class PrestamoController {
    ...
    public ResponseEntity<Response> listarPorPrestamo(@PathVariable("id") int id) {
        try {
            return ResponseEntity.status(HttpStatus.OK).body(new Response(prestamoService.obtenerPrestamoPorId(id), "Lista de prestamos del Id = [ " + id + " ]."));
        } catch (Exception e) {
            log.info("Error: {}", e.getMessage());
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(new Response("Error al listar el prestamo = [ " + id + " ]."));
        }
    }
    ...
    public ResponseEntity<Response> validarSolicitud(@PathVariable("id") int id) {
        try {
            ...
            if (!prestamos.isEmpty()) {
                return ResponseEntity.status(HttpStatus.OK).body(new Response(prestamos, "Usted tiene un préstamo en Curso."));
            } else {
                ...
                if (!solicitudes.isEmpty()) {
                    ...
                    if (_solicitud.isPresent()) {
                        return ResponseEntity.status(HttpStatus.OK).body(new Response(_solicitud, "Usted tiene una solicitud de prestamo por Aprobar."));
                    } else {
                        return ResponseEntity.status(HttpStatus.OK).body(new Response("No tiene solicitudes pendientes."));
                    }
                } else {
            ...
            log.info("Error: {}", e.getMessage());
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(new Response("Ocurrió un error al validar las solicitudes Pendientes."));
        }
    }
    ...
    public ResponseEntity<Response> listarPorPrestamista(@PathVariable("id") int id) {
        try {
            return ResponseEntity.status(HttpStatus.OK).body(new Response(prestamoService.obtenerPrestamosPorPrestamista(id), "Lista de prestamos por prestamista."));
        } catch (Exception e) {
            log.info("Error: {}", e.getMessage());
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(new Response("Error al listar los prestamos por prestamista."));
        }
    }
    ...
    public ResponseEntity<Response> listarPorPrestatario(@PathVariable("id") int id) {
        try {
            return ResponseEntity.status(HttpStatus.OK).body(new Response(prestamoService.obtenerPrestamosPorPrestatario(id), "Lista de prestamos por prestatario."));
        } catch (Exception e) {
            log.info("Error: {}", e.getMessage());
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(new Response("Error al listar los prestamos por prestatario."));
        }
    }
    ...
    public ResponseEntity<Response> listarPorGrupoPrestamista(@PathVariable("id") int id) {
        try {
            return ResponseEntity.status(HttpStatus.OK).body(new Response(prestamoService.obtenerPrestamosPorGrupoPrestamista(id), "Lista de prestamos por grupo prestamista."));
        } catch (Exception e) {
            log.info("Error: {}", e.getMessage());
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(new Response("Error al listar los prestamos por grupo prestamista."));
        }
    }
    ...
    public ResponseEntity<Response> listarPorJefePrestamista(@PathVariable("id") int id) {
        try {
            ...
            if (prestamos.isEmpty()) {
                return ResponseEntity.status(HttpStatus.OK).body(new Response("No se encontró prestamos del Jefe de Prestamis - Id = [ " + id + " ]."));
            }else {
                return ResponseEntity.status(HttpStatus.OK).body(new Response(prestamos, "Lista de prestamos del Jefe de prestamista Id = [ " + id + " ]."));
            }
        } catch (Exception e) {
            log.info("Error: {}", e.getMessage());
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(new Response("Error al listar los prestamos por jefe de grupo prestamista."));
        }
    }
